...
Here is the source code for TopCap and related models from the [article](https://yifeizhu.github.io/tail.pdf){:target="_blank"}.  The data that support the findings of this study are openly available in [SpeechBox, ALLSSTAR Corpora](https://speechbox.linguistics.northwestern.edu/allsstar){:target="_blank"}, as well as [LJSpeech](https://keithito.com/LJ-Speech-Dataset/){:target="_blank"}, [TIMIT](https://catalog.ldc.upenn.edu/LDC93S1){:target="_blank"}, and [LibriSpeech](https://www.openslr.org/12){:target="_blank"}.  
