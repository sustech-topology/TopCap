...
**Figure generation**: All figures in the [manuscript](https://yifeizhu.github.io/tail.pdf) are generated by Adobe Illustrator from the plots obtained through the Python scripts.  

Corresponding to the subheaded sections in the Results section of the [manuscript](https://yifeizhu.github.io/tail.pdf), there are four main directories as follows, including one which contains additional code and material.  
